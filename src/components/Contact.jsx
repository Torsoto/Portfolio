...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="grid w-full p-4 lg:p-8 bg-[#161b22]   grid-row-3"
    >
      ...
      <div
        ref={ref}
        className={inView ? "fadeDown bg-[#161b22] " : "invisible bg-[#161b22]"}
      >
        <div className="mx-auto text-white grid-col-3 bg-[#161b22] xl:w-[35%] lg:w-[45%] md:w-[60%] w-[80%]">
