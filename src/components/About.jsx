...
export const About = () => {
  ...
  return (
    <div
      id="about"
      className={`z-0 w-full px-4 pt-20  pb-60 ${isDarkMode ? "bg-[#161b22]" : "bg-white text-black "
        } `}
    >
      <div className="bg-transparent ">
        <h2
          className={`text-3xl font-bold tracking-widest text-center bg-transparent lg:text-4xl ${isDarkMode ? "text-white" : "text-black"
            }`}
        >
      ...
      <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 pt-20 lg:grid-col-2 xl:grid-col-2 place-items-center bg-transparent">
        ...
        <p className="pt-8 mx-4 tracking-tighter text-justify text-white bg-transparent md:pt-0 font-Montserrat md:text-xl lg:text-2xl">
          ...
          {isEnglish
            ? ", a 23-year-old student at FH Campus Wien."
            : " bin 23 Jahre alt und studiere im Moment and der FH Campus Wien."}
          <br />
          <br />
          {isEnglish
