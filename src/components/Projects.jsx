  ...
  return (
    <div id="projects" className="bg-[#1d1e26] pt-8 pb-12 text-white">
      ...
      >
        ...
        <div className="grid m-2 text-3xl align-middle transition-all duration-200 ease-in-out cursor-pointer rounded-xl place-items-center hover:scale-105 bg-[#1d1e26] active:translate-y-2">
