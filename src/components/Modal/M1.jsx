  ...
  return (
    ...
    >
      <div
        ...
        className=" p-2 text-black bg-[#161b22] rounded-3xl overflow-hidden max-w-[1200px] w-[90%] fadeIn"
      >
        <div className="flex justify-end pt-1 pb-2 mt-0 align-top bg-[#161b22]">
          <button
            onClick={onClose}
            className="flex justify-end w-[18px] text-4xl md:w-[35px]  text-black align-middle"
          >
            <AiFillCloseCircle size={35} className="bg-[#161b22] text-white" />
          </button>
        </div>
        <div className="mx-auto bg-[#161b22]  md:w-[62%]">
          <Carousel>
            {[
              ...slides.map((s) => (
                <img
        ...
        <div className="px-0 pt-8 bg-[#161b22] md:px-10 md:pt-10">
          <div className="flex bg-[#161b22]">
            <h1 className="pb-1 text-[#fe3e57] text-base bg-[#161b22] md:text-2xl font-Poppins">
              {" "}
            ...
            >
              <FaGithubSquare
                size={30}
                className="mt-[3px] w-[18px] h-[18px] text-white md:w-[30px] md:h-[30px] ml-2 transition-all duration-300 ease-in-out bg-[#161b22] hover:scale-125"
              />
            </a>
          </div>
          <p className="text-justify text-white bg-[#161b22] text-[10px] sm:text-sm md:text-lg lg:text-xl font-Montserrat">
            {isEnglish
        ...
        <div className="flex gap-4 pt-4 text-white text-center bg-[#161b22] place-content-center lg:pt-6">
          <div className="bg-[#161b22] ">
            <img
              src={Java}
              alt="JavaFX Logo"
              className="mx-auto bg-[#161b22] w-[32px] h-[32px] lg:w-[48px] lg:h-[48px]"
            />
            <p className="text-xs lg:text-[16px] bg-[#161b22] md:text-base">
              JavaFX
            </p>
          </div>
          <div className="bg-[#161b22]">
            <img
              src={JSON}
              alt="JSON Logo"
              className="bg-[#161b22] w-[32px] h-[32px] lg:w-[48px] lg:h-[48px]"
            />
            <p className="text-xs lg:text-[16px] bg-[#161b22] md:text-base">
              JSON
            </p>
